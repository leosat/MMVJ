...
pub(super) async fn run_aux_task(
    ...
    match aux_task {
        ...
        AuxDriverTask::MidiLearn => {
            MidiLearnMode::new(MidiManager::new(true)?).run().await?;
        }
...
pub(super) async fn run_mapping_engine(
    config_path: std::path::PathBuf,
    debug: bool,
    debug_ff: bool,
...
pub(super) fn check_system_requirements() -> Result<()> {
